...
$BASEURL = 'http://127.0.0.1:801/book/bo/';
define('BASEPATH', $_SERVER['DOCUMENT_ROOT'] . '/book/bo/');
define('FILEUPLOADPATH', $_SERVER['DOCUMENT_ROOT'] . '/book/bo/web/upload/');
define('BASEURL', $BASEURL);
define('PROFILEPICUPLOAD', $_SERVER['DOCUMENT_ROOT'] . '/book/web/upload/');

$FrontEnd = 'http://127.0.0.1:801/book/';
