...
class ExportBtcWalletController extends Controller {
    ...
    public function actionExport(){
        ...
        $data  = $model->callsql("SELECT * FROM export_request_list WHERE id='$post_id' AND report = 6 AND status = 0","row");
        ...
        if(!empty($data)){
            ...
            $filename_nw = 'btc_wallet_history_'.$post_id.'_'.$time_nw.'.csv';
