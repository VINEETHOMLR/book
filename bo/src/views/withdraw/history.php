...
use inc\Raise;
$this->mainTitle = 'Withdraw History';
         ...
         <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="row">
                       <form id="withdraw_form" class="row col-md-12" method="post" action="<?=BASEURL;?>Withdraw/Index/">
                        ...
                        <div class="row col-md-12 col-lg-12">
                          ...
                          <div class="col-md-4 col-xl-4 col-sm-12">
                            <div class="badge outline-badge-primary  mr-3 mb-1 col-12 p-3">Total ETH :<?=number_format($data['total']['eth'],$wallet_decimal_limits['eth'])?></div>
                    ...
                    <div class="table-responsive mb-4 mt-4" style="overflow-x: scroll !important;">
                        <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                  ...
                                  if(!empty($data['data'])){
                                   foreach($data['data'] as $key => $val): ?>
                                    <tr role="row" class="odd">
                                      ...
                                      <td><?=$val['coin_name']?></td>
                                      <td><?=number_format($val['amount'],$wallet_decimal_limits[$val['coin_code']])?></td>
                                      <td><?=$val['trans_hash']?></td>
                          ...
                          <div class="row text-center">
                            <form class="col-md-12" id="withdraw_pagination" method="post" action="<?=BASEURL;?>Withdraw/Index/">
...
function exportReport(){
  ...
  $.post('<?=BASEURL?>export/Withdraw',{'datefrom':datefrom,'dateto':dateto,'status':status,'coin':coin,'username':username},
      function(response){
          hideoverlay();
...
$( function() {
  ...
  function approveThis(id,type){
	  if(type ==2){
		  var text1 = "Approve this withdrawal";
		  var confirmtext1 = "Approve";
	  }else{
		  var text1 = "Reject this withdrawal";
		  var confirmtext1 = "Reject";
	  }
     ...
     swal({
          ...
          confirmButtonText: confirmtext1+'',
          padding: '2em'
        }).then(function(result) {
            if (result.value) {
               loadingoverlay('info',"Please wait..","loading...");
               $.post('<?= BASEURL ?>Withdraw/Approve/',{getId:id,type:type},function(response){ 
