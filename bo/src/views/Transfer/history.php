...
use inc\Raise;
$this->mainTitle = 'Transfer History';
         ...
         <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="row">
                       <form id="transfer_form" class="row col-md-12" method="post" action="<?=BASEURL;?>Transfer/Index/">
                        ...
                        <div class="row col-md-12 col-lg-12">
                          ...
                          <div class="col-md-3 col-xl-3 col-sm-12">
                            <div class="badge outline-badge-primary  mr-3 mb-1 col-12 p-3">Total ITT :<?=number_format($data['total']['itt'],$wallet_decimal_limits['usd'])?></div>
                    ...
                    <div class="table-responsive mb-4 mt-4" style="overflow-x: scroll !important;">
                        <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                            ...
                            <div class="col-sm-12">
                              <table id="dt" class="table table-hover dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="dt_info">
                                <thead>
                                  ...
                                  <th class="sorting_disabled" rowspan="1" colspan="1">Credit Type</th>
                                  <th class="sorting_disabled" rowspan="1" colspan="1">Transfer Date</th>
                          ...
                          <div class="row text-center">
                            <form class="col-md-12" id="transfer_pagination" method="post" action="<?=BASEURL;?>Transfer/Index/">
...
function pageHistory(datefrom,dateto,coin,status,username,credit,page){
...
function exportReport(){
  ...
  $.post('<?=BASEURL?>export/Transfer',{'datefrom':datefrom,'dateto':dateto,'status':status,'coin':coin,'username':username,'creditType':creditType},
      function(response){
          hideoverlay();
