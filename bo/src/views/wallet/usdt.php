                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="row">
                        <div class="row col-md-12 col-xs-12">
                            <form id="btc_form" class="row col-md-12" method="post" action="<?=BASEURL;?>Wallet/Usdt/">
                    ...
                    <div class="col-lg-5">
                      ...
                      <div class="badge outline-badge-primary col-12 text-center pull-left" style="padding: 10px"><?=Raise::t('wallet','total_amt')?>: <?=number_format($sum,$wallet_decimal_limits['usdt'])?></div>
                    </div>
                    ...
                    <div class="table-responsive mb-4 mt-4" style="overflow-x: scroll !important;">
                        <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                  ...
                                  if(!empty($data['data'])){
                                   foreach($data['data'] as $key => $val):?>
                                    <tr role="row" class="odd">
                                      ...
                                      <td><?=$val['txn_type']?></td>
                                      <td><?=number_format($val['value'],$wallet_decimal_limits['usdt'])?></td>
                                      <td><?=number_format($val['before_bal'],$wallet_decimal_limits['usdt'])?></td>
                                      <td><?=number_format($val['after_bal'],$wallet_decimal_limits['usdt'])?></td>
                                      <td><?=$val['txn_date']?></td>
                                      <td><?=$val['remarks']?></td>
                                    </tr>
                                <?php endforeach;
                          ...
                          <div class="row text-center">
                            <form class="col-md-12" id="btc_pagination" method="post" action="<?=BASEURL;?>wallet/Usdt">
...
function exportReport(){
        ...
        $.post('<?=BASEURL?>export/Usdt',{'txn_type':txn_type,'creditType':creditType,'datefrom':datefrom,'dateto':dateto,'username':username,'coin_code':'usdt'},
            function(response){
          hideoverlay();
