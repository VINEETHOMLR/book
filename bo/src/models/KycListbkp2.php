...
class KycList extends Database {
    ...
    public function getKYCList($data){
        ...
        foreach ($result['data'] as $key => $value) {
            ...
            $fullname=$this->callsql("SELECT fullname FROM user WHERE id='$value[user_id]'",'value');
                ...
                $result['data'][$key]['id_img'] = (empty($value['kyc_id_front_image'])) ? "-" :
                ...
                $result['data'][$key]['id_img'].=(!empty($value['kyc_id_back_image'])) ? '<a target="_blank"  href="'.$this->urlid.$value['kyc_id_back_image'].'" data-lightbox="1"  data-lightbox="pic" data-title=""><img src="'.$this->urlid.$value['kyc_id_back_image'].'" width="50px" height="50px"></a>
                ':'';
    ...
    public function getKycdetails($id){
      ...
      $data['data'] = $this->callsql("SELECT * FROM user_info  WHERE id =$id ", "rows");
      $Status = array(0=>"Not Updated",1=>"Pending", 2=>"Approved", 3=>"Rejected");
      $this->urlid=FrontEnd.'web/upload/kyc/'; 
      $this->urlp=FrontEnd.'web/upload/kyc/';
      ...
      foreach ($data['data'] as $key => $value) {
        ...
        $data['data'][$key]['fullname']      = $userDetails['fullname'];
        $data['data'][$key]['username']     = $userDetails['username'];
        $data['data'][$key]['status'] = $Status[$value['kyc_status']];
        $data['data'][$key]['time']   = (empty($value['created_at'])) ? "-" : date("d-m-Y H:i:s",$value['created_at']);
        $data['data'][$key]['remarks']   = (empty($value['kyc_admin_remarks'])) ? "-" : $value['kyc_admin_remarks'];
        $data['data'][$key]['id_number'] =(empty($value['kyc_id_number'])) ? "-" : $value['kyc_id_number'];
        $data['data'][$key]['passport_number'] =(empty($value['kyc_passport_number'])) ? "-" : $value['kyc_passport_number'];
        $data['data'][$key]['id_real_name'] =(empty($value['kyc_id_real_name'])) ? "-" : $value['kyc_id_real_name'];
        $data['data'][$key]['passport_real_name'] =(empty($value['kyc_passport_real_name'])) ? "-" : $value['kyc_passport_real_name'];
        $data['data'][$key]['passport'] = (empty($value['kyc_passport_image'])) ? "-" :
          '<a target="_blank" href="'.$this->urlp.$value['kyc_passport_image'].'" data-lightbox="1"  data-lightbox="pic" data-title=""><img src="'.$this->urlp.$value['kyc_passport_image'].'" width="50px" height="50px"></a>';
        $data['data'][$key]['passport_photo'] = (empty($value['kyc_passport_photo'])) ? "-" :

          '<a target="_blank" href="'.$this->urlp.$value['kyc_passport_photo'].'" data-lightbox="1"  data-lightbox="pic" data-title=""><img src="'.$this->urlp.$value['kyc_passport_photo'].'" width="50px" height="50px"></a>
                ';
        $data['data'][$key]['passport_document'] = (empty($value['kyc_passport_document'])) ? "-" :

          '<a target="_blank" href="'.$this->urlp.$value['kyc_passport_document'].'" data-lightbox="1"  data-lightbox="pic" data-title=""><img src="'.$this->urlp.$value['kyc_passport_document'].'" width="50px" height="50px"></a>
                ';
        $data['data'][$key]['id_img'] = (empty($value['kyc_id_front_image'])) ? "-" :
                
                '<a target="_blank"  href="'.$this->urlid.$value['kyc_id_front_image'].'" data-lightbox="1"  data-lightbox="pic" data-title=""><img src="'.$this->urlid.$value['kyc_id_front_image'].'" width="50px" height="50px"></a> &nbsp';

        $data['data'][$key]['id_img'].=(!empty($value['kyc_id_back_image'])) ? '<a target="_blank"  href="'.$this->urlid.$value['kyc_id_back_image'].'" data-lightbox="1"  data-lightbox="pic" data-title=""><img src="'.$this->urlid.$value['kyc_id_back_image'].'" width="50px" height="50px"></a>
                ':'';
        $data['data'][$key]['id_doc'] = (empty($value['kyc_id_document'])) ? "-" :
                
          '<a target="_blank" href="'.$this->urlid.$value['kyc_id_document'].'" data-lightbox="1"  data-lightbox="pic" data-title=""><img src="'.$this->urlid.$value['kyc_id_document'].'" width="50px" height="50px"></a>';
